...
//  mams.paps
//
//  Created by Руслан Гайфуллин on 24.01.2024.
//

import UIKit
import YandexMapsMobile

final class TestMapView: UIView {
    
    
    var controller: YandexMapViewController

  
    
    init(frame: CGRect, controller: YandexMapViewController) {
